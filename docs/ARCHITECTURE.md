...
readiness bridge as TCP/UDP sockets. The complete runtime tun packet loop and
TCP state machine are not implemented yet, and macOS/iOS/Windows device wiring
is still separate remaining work.
